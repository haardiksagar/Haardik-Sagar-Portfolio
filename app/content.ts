...
export const projects = [
  {
    ...
    role: "Creator",
    detail: "A single-node, low-latency stock exchange matching engine built from scratch in Java 21. Inspired by the LMAX Disruptor architecture used by real financial exchanges to process millions of orders per second.",
